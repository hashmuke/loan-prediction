...
see [`Extension.md`](Extension.md) for chnages from the original code provided by [Vik Paruchuri](https://www.dataquest.io/blog/data-science-portfolio-machine-learning/).
